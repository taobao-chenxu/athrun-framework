...
public class ViewFetcher {
	...
	/**
	 * Extracts all Views located in the currently active Activity, recursively.
	 *
	 * @param parent the View whose children should be returned, or null for all
	 * @param onlySufficientlyVisible if only sufficiently visible views should be returned
	 * @return all Views located in the currently active Activity, never null
	 */
	 ...
	 *
	 * @param views an ArrayList of Views
	 * @param viewGroup the ViewGroup to extract children from
	 * @param onlySufficientlyVisible if only sufficiently visible views should be returned
	 */
	 ...
	 *            of views from a set of types, such as Button,
	 *            TextView or ScrollView, ListView
