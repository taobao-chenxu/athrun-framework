...
/**
 * Used to create a TextView object that is based on a web element. 
 * Contains the web element text and location.  
 * 
...
class WebTextView extends TextView {
	...
	public WebTextView(Context context, String text, int locationX, int locationY) {
		super(context);
		this.setText(text);
